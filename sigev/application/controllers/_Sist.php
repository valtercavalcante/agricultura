   ...
   A Coordenação do I SEMPREIFPI agradece sua presença.
	...
	public function gera_certificados($id_atividade,$id_participante)
	{
		...
		switch ($atividade->tipo) {
        	...
        	break;
    		case 2:
        		$texto = "Certificamos que ".$participante->nome." participou da mini-curso ". $atividade->nome. ", no I SEMPREIFPI do Instituto Federal do Piauí realizado de 23 a 25 de novembro de 2016, no campus Valença do Piauí, com carga horária de 2h/a.";
        	break;
    		case 3:
        		$texto = "Certificamos que ".$participante->nome." participou da oficina ". $atividade->nome. ", no I SEMPREIFPI do Instituto Federal do Piauí realizado de 23 a 25 de novembro de 2016, no campus Valença do Piauí, com carga horária de 2h/a.";
        	break;
		}
		$data['certificado']="";
		//$texto = "Certificamos que ".$participante->nome." participou da palestra ". $atividade->nome. ", no I SEMPREIFPI do Instituto Federal do Piauí realizado de 23 a 25 de novembro de 2016, no campus Valença do Piauí, com carga horária de 2h/a.";
